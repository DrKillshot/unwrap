...
describe("Either container", () => {
    describe("Either constructors", () => {
        ...
        it.each([null, undefined])(
            'should create an Error container when fromNullable is called with "%s"',
            (nullable) => {
        ...
        it("should return error if error is thrown in function", () => {
        ...
        it("should return value if function does not throw error", () => {
            const value = "ok"
            const result = Either.fromThrowable(() => {
                return value
            })
    ...
    describe("Map operator", () => {
        it.each([
            ...
            [
                ...
                Either.Ok([false, true, false, true]),
            ],
            [
                { name: "An object" },
            ...
            'should map "%s" the when Either is of type Ok',
            (input, transformation, final) => {
                // @ts-ignore
        ...
        it.each([
            ...
            'should not map "%s" if Either is of type Error',
    ...
    describe("MapError operator", () => {
        it.each([
            ...
            [
                [1, 2, 3, 4],
                (arr: number[]) => arr.map((x) => x % 2 == 0),
                Either.Error([false, true, false, true]),
            ],
            [
                { name: "An object" },
                (obj: { name: string }) => obj.name,
                Either.Error("An object"),
            ],
        ])(
            'should map "%s" the when Either is of type Error',
            (input, transformation, final) => {
                // @ts-ignore
        ...
        it.each([
            ...
            'should not map "%s" if Either is of type Ok',
            (input, transformation) => {
                // @ts-ignore
    ...
    describe("Flatmap operator", () => {
        it.each([
            ...
            [
                "Hello world!",
                (s: string) => Either.Ok(s.toUpperCase()),
                Either.Ok("HELLO WORLD!"),
            ],
            [
                [1, 2, 3, 4],
                (arr: number[]) => Either.Ok(arr.map((x) => x % 2 == 0)),
                Either.Ok([false, true, false, true]),
            ],
            [
                { name: "An object" },
                (obj: { name: string }) => Either.Ok(obj.name),
                Either.Ok("An object"),
            ],
            ...
            [
                "Hello world!",
                (s: string) => Either.Error(s.toUpperCase()),
                Either.Error("HELLO WORLD!"),
            ],
            [
                [1, 2, 3, 4],
                (arr: number[]) => Either.Error(arr.map((x) => x % 2 == 0)),
                Either.Error([false, true, false, true]),
            ],
            [
                { name: "An object" },
                (obj: { name: string }) => Either.Error(obj.name),
                Either.Error("An object"),
            ],
        ])(
            'it should flatten the transformation "%s"',
            (input, transformation, final) => {
                // @ts-ignore
        ...
        it.each([
            ...
            'it should not apply the transformation "%s" when Either type is Error',
            (input, transformation) => {
                // @ts-ignore
    ...
    describe("IsOk and IsError operator", () => {
        it.each([
            ...
            "should return true when isOk is called and Either is of type Ok and false otherwise",
            (result, expected) => {
        ...
        it.each([
            ...
            "should return true when isError is called and Either is of type Error and false otherwise",
            (result, expected) => {
    ...
    describe("Match operator", () => {
        it.each([
            ...
            [
                Either.Error("This is an error string"),
                { Ok: false, Error: (s: string) => s.toUpperCase() },
                "THIS IS AN ERROR STRING",
            ],
            [
                Either.Error([null, null, undefined]),
                {
                    Ok: false,
                    Error: {
                        message:
                            "There has been an error processing the input.",
                    },
                },
                { message: "There has been an error processing the input." },
            ],
        ])(
    ...
    describe("To maybe operator", () => {
        it.each([
            ...
            'should return an maybe with a value if Either "%s" type is Ok',
            (result) => {
        ...
        it.each([
            ...
            'should return an None maybe if Either "%s" type is Error',
            (result) => {
                const maybe = result.toMaybe()
    ...
    describe("Unwrap and unwrapError operators", () => {
        it.each([
            ...
            'should return the value "%s" on unwrap call if Either is Ok',
            (value) => {
        ...
        it.each([
            ...
            'should return the value "%s" on unwrapError call if Either is Error',
            (value) => {
